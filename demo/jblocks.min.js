(function(b){function a(a,d){var j,n,u;function t(a){b("body").addClass("noSelect");var c=parseInt(k.obj.css(q),10);j=m?a.pageX:a.pageY;n="auto"==c?0:c;J?(document.ontouchmove=function(b){b.preventDefault();r(b.touches[0])},document.ontouchend=v):(b(document).bind("mousemove",r),b(document).bind("mouseup",v),k.obj.bind("mouseup",v))}function l(a){if(1>f.ratio&&(a=a||window.event,x-=(a.wheelDelta?a.wheelDelta/120:-a.detail/3)*d.wheel,x=Math.min(f[d.axis]-s[d.axis],Math.max(0,x)),k.obj.css(q,x/g.ratio),
f.obj.css(q,-x),d.lockscroll||x!==f[d.axis]-s[d.axis]&&0!==x))a=b.event.fix(a),a.preventDefault()}function r(b){1>f.ratio&&(u=d.invertscroll&&J?Math.min(e[d.axis]-k[d.axis],Math.max(0,n+(j-(m?b.pageX:b.pageY)))):Math.min(e[d.axis]-k[d.axis],Math.max(0,n+((m?b.pageX:b.pageY)-j))),x=u*g.ratio,f.obj.css(q,-x),k.obj.css(q,u))}function v(){b("body").removeClass("noSelect");b(document).unbind("mousemove",r);b(document).unbind("mouseup",v);k.obj.unbind("mouseup",v);document.ontouchmove=document.ontouchend=
null}var s={obj:b(".viewport",a)},f={obj:b(".overview",a)},g={obj:b(".scrollbar",a)},e={obj:b(".track",g.obj)},k={obj:b(".thumb",g.obj)},m="x"===d.axis,q=m?"left":"top",h=m?"Width":"Height",x=0;u=n=0;j=void 0;var J="ontouchstart"in document.documentElement;this.update=function(b){s[d.axis]=s.obj[0]["offset"+h];f[d.axis]=f.obj[0]["scroll"+h];f.ratio=s[d.axis]/f[d.axis];g.obj.toggleClass("disable",1<=f.ratio);e[d.axis]="auto"===d.size?s[d.axis]:d.size;k[d.axis]=Math.min(e[d.axis],Math.max(0,"auto"===
d.sizethumb?e[d.axis]*f.ratio:d.sizethumb));g.ratio="auto"===d.sizethumb?f[d.axis]/e[d.axis]:(f[d.axis]-s[d.axis])/(e[d.axis]-k[d.axis]);x="relative"===b&&1>=f.ratio?Math.min(f[d.axis]-s[d.axis],Math.max(0,x)):0;x="bottom"===b&&1>=f.ratio?f[d.axis]-s[d.axis]:isNaN(parseInt(b,10))?x:parseInt(b,10);b=h.toLowerCase();k.obj.css(q,x/g.ratio);var a={};a[q]=-x;d.animation?f.obj.animate(a,d.animation):f.obj.css(q,-x);j=k.obj.offset()[q];g.obj.css(b,e[d.axis]);e.obj.css(b,e[d.axis]);k.obj.css(b,k[d.axis])};
this.update();J?s.obj[0].ontouchstart=function(b){1===b.touches.length&&(t(b.touches[0]),b.stopPropagation())}:(k.obj.bind("mousedown",t),e.obj.bind("mouseup",r));d.scroll&&window.addEventListener?(a[0].addEventListener("DOMMouseScroll",l,!1),a[0].addEventListener("mousewheel",l,!1)):d.scroll&&(a[0].onmousewheel=l);return this}b.tiny=b.tiny||{};b.tiny.scrollbar={options:{axis:"y",wheel:40,scroll:!0,lockscroll:!0,size:"auto",sizethumb:50,invertscroll:!0,animation:0}};b.fn.tinyscrollbar=function(c){var d=
...
(function(b){function a(a){if(a&&void 0===a.allowPageScroll&&(void 0!==a.swipe||void 0!==a.swipeStatus))a.allowPageScroll=r;a||(a={});a=b.extend({},b.fn.swipe.defaults,a);return this.each(function(){var d=b(this),e=d.data(x);e||(e=new c(this,a),d.data(x,e))})}function c(a,c){function L(a){if(!0!==y.data(x+"_intouch")&&!(0<b(a.target).closest(c.excludedElements,y).length)){a=a.originalEvent;var p,d=h?a.touches[0]:a;z=e;h?B=a.touches.length:a.preventDefault();E=0;M=G=null;H=P=C=0;N=1;for(var f=[],j=
0;5>=j;j++)f.push({start:{x:0,y:0},end:{x:0,y:0},delta:{x:0,y:0}});w=f;if(!h||B===c.fingers||c.fingers===g||R()){if(w[0].start.x=w[0].end.x=d.pageX,w[0].start.y=w[0].end.y=d.pageY,V=(new Date).getTime(),2==B&&(w[1].start.x=w[1].end.x=a.touches[1].pageX,w[1].start.y=w[1].end.y=a.touches[1].pageY,P=H=O(w[0].start,w[1].start)),c.swipeStatus||c.pinchStatus)p=A(a,z)}else I(a),p=!1;if(!1===p)return z=q,A(a,z),p;F(!0);y.bind(Y,D);y.bind(Z,K)}}function D(b){b=b.originalEvent;if(!(z===m||z===q)){var a,p=h?
b.touches[0]:b;w[0].end.x=h?b.touches[0].pageX:p.pageX;w[0].end.y=h?b.touches[0].pageY:p.pageY;S=(new Date).getTime();G=T(w[0].start,w[0].end);h&&(B=b.touches.length);z=k;2==B&&(0==P?(w[1].start.x=b.touches[1].pageX,w[1].start.y=b.touches[1].pageY,P=H=O(w[0].start,w[1].start)):(w[1].end.x=b.touches[1].pageX,w[1].end.y=b.touches[1].pageY,H=O(w[0].end,w[1].end),M=1>N?l:t),N=(1*(H/P)).toFixed(2));if(B===c.fingers||c.fingers===g||!h){var p=b,e=G;if(c.allowPageScroll===r||R())p.preventDefault();else{var F=
c.allowPageScroll===v;switch(e){case d:(c.swipeLeft&&F||!F&&c.allowPageScroll!=s)&&p.preventDefault();break;case j:(c.swipeRight&&F||!F&&c.allowPageScroll!=s)&&p.preventDefault();break;case n:(c.swipeUp&&F||!F&&c.allowPageScroll!=f)&&p.preventDefault();break;case u:(c.swipeDown&&F||!F&&c.allowPageScroll!=f)&&p.preventDefault()}}E=Q(w[0].start,w[0].end);C=S-V;if(c.swipeStatus||c.pinchStatus)a=A(b,z);c.triggerOnTouchEnd||(p=!(c.maxTimeThreshold?!(C>=c.maxTimeThreshold):1),!0===(null!==c.threshold?E>=
c.threshold:null)?(z=m,a=A(b,z)):p&&(z=q,A(b,z)))}else z=q,A(b,z);!1===a&&(z=q,A(b,z))}}function K(b){b=b.originalEvent;if(b.touches&&0<b.touches.length)return!0;b.preventDefault();S=(new Date).getTime();0!=P&&(H=O(w[0].end,w[1].end),N=(1*(H/P)).toFixed(2),M=1>N?l:t);E=Q(w[0].start,w[0].end);G=T(w[0].start,w[0].end);C=S-V;if(c.triggerOnTouchEnd||!1===c.triggerOnTouchEnd&&z===k){z=m;var a=M&&R()||!R(),p=0!==w[0].end.x;if((B===c.fingers||c.fingers===g||!h)&&p&&a)if(a=c.maxTimeThreshold?C>=c.maxTimeThreshold?
!1:!0:!0,p=null!==c.threshold?E>=c.threshold:null,(!0===p||null===p)&&a)A(b,z);else{if(!a||!1===p)z=q,A(b,z)}else z=q,A(b,z)}else z===k&&(z=q,A(b,z));y.unbind(Y,D,!1);y.unbind(Z,K,!1);F(!1)}function I(){H=P=V=S=B=0;N=1;F(!1)}function A(b,a){var p=void 0;c.swipeStatus&&(p=c.swipeStatus.call(y,b,a,G||null,E||0,C||0,B));c.pinchStatus&&(M&&R())&&(p=c.pinchStatus.call(y,b,a,M||null,H||0,C||0,B,N));if(a===q&&c.click&&(1===B||!h)&&(isNaN(E)||0===E))p=c.click.call(y,b,b.target);if(a==m){c.swipe&&(p=c.swipe.call(y,
b,G,E,C,B));switch(G){case d:c.swipeLeft&&(p=c.swipeLeft.call(y,b,G,E,C,B));break;case j:c.swipeRight&&(p=c.swipeRight.call(y,b,G,E,C,B));break;case n:c.swipeUp&&(p=c.swipeUp.call(y,b,G,E,C,B));break;case u:c.swipeDown&&(p=c.swipeDown.call(y,b,G,E,C,B))}switch(M){case t:c.pinchIn&&(p=c.pinchIn.call(y,b,M||null,H||0,C||0,B,N));break;case l:c.pinchOut&&(p=c.pinchOut.call(y,b,M||null,H||0,C||0,B,N))}}(a===q||a===m)&&I(b);return p}function O(b,a){var p=Math.abs(b.x-a.x),c=Math.abs(b.y-a.y);return Math.round(Math.sqrt(p*
p+c*c))}function Q(b,a){return Math.round(Math.sqrt(Math.pow(a.x-b.x,2)+Math.pow(a.y-b.y,2)))}function T(b,a){var p;p=Math.atan2(a.y-b.y,b.x-a.x);p=Math.round(180*p/Math.PI);0>p&&(p=360-Math.abs(p));return 45>=p&&0<=p?d:360>=p&&315<=p?d:135<=p&&225>=p?j:45<p&&135>p?u:n}function p(){y.unbind(W,L);y.unbind(X,I);y.unbind(Y,D);y.unbind(Z,K);F(!1)}function R(){return c.pinchStatus||c.pinchIn||c.pinchOut}function F(b){y.data(x+"_intouch",!0===b?!0:!1)}var aa=h||!c.fallbackToMouseEvents,W=aa?"touchstart":
"mousedown",Y=aa?"touchmove":"mousemove",Z=aa?"touchend":"mouseup",X="touchcancel",E=0,G=null,C=0,P=0,H=0,N=1,M=0,y=b(a),z="start",B=0,w=null,V=0,S=0;try{y.bind(W,L),y.bind(X,I)}catch(ba){b.error("events not supported "+W+","+X+" on jQuery.swipe")}this.enable=function(){y.bind(W,L);y.bind(X,I);return y};this.disable=function(){p();return y};this.destroy=function(){p();y.data(x,null);return y}}var d="left",j="right",n="up",u="down",t="in",l="out",r="none",v="auto",s="horizontal",f="vertical",g="all",
e="start",k="move",m="end",q="cancel",h="ontouchstart"in window,x="TouchSwipe";b.fn.swipe=function(c){var d=b(this),e=d.data(x);if(e&&"string"===typeof c){if(e[c])return e[c].apply(this,Array.prototype.slice.call(arguments,1));b.error("Method "+c+" does not exist on jQuery.swipe")}else if(!e&&("object"===typeof c||!c))return a.apply(this,arguments);return d};b.fn.swipe.defaults={fingers:1,threshold:75,maxTimeThreshold:null,swipe:null,swipeLeft:null,swipeRight:null,swipeUp:null,swipeDown:null,swipeStatus:null,
pinchIn:null,pinchOut:null,pinchStatus:null,click:null,triggerOnTouchEnd:!0,allowPageScroll:"auto",fallbackToMouseEvents:!0,excludedElements:"button, input, select, textarea, a, .noSwipe"};b.fn.swipe.phases={PHASE_START:e,PHASE_MOVE:k,PHASE_END:m,PHASE_CANCEL:q};b.fn.swipe.directions={LEFT:d,RIGHT:j,UP:n,DOWN:u,IN:t,OUT:l};b.fn.swipe.pageScroll={NONE:r,HORIZONTAL:s,VERTICAL:f,AUTO:v};b.fn.swipe.fingers={ONE:1,TWO:2,THREE:3,ALL:g}})(jQuery);
...
a.options.fontSizeRatio+"pt"}));a.checkLayout()},a.options.resizeDelay);b.stopPropagation()});b(document).bind("jblocks.login",function(b,c){a.loggedIn=c;for(var d in a.blocks)a.blocks[d].onLoggedIn(c)});b(document).bind("jblocks.logout",function(){a.loggedIn=null;for(var b in a.blocks)a.blocks[b].onLoggedOut()});this.updateOptions({});this.checkLayout()};c.prototype.getSelf=function(){return this};c.prototype.newBlock=function(){if(!e[arguments[0]])throw"Unknown class "+arguments[0];var b=e[arguments[0]],
a=Array.prototype.slice.call(arguments,1);a.jBlocksArgsList=!0;b=new b(a);b.className=arguments[0];return b};c.prototype.addBlock=function(b){this.blocks[b.id]=b;b.jBlocks=this;D&&b.create(this.anchor);this.checkLayout()};c.prototype.addNewBlock=function(){var b=c.prototype.newBlock.apply(this,arguments);this.addBlock(b);return b};c.prototype.removeBlock=function(b){var a=this.blocks[b];a&&(a.onRemove(),delete this.blocks[b]);this.checkLayout()};c.prototype.blocksByTag=function(b){var a=[],c;for(c in this.blocks){var d=
this.blocks[c];d.tags[b]&&a.push(d)}return a};c.prototype.removeBlocksByTag=function(b){b=this.blocksByTag(b);for(var a in b)this.removeBlock(b[a].id)};c.prototype.removeAllBlocks=function(){for(var b in this.blocks)this.removeBlock(this.blocks[b].id)};c.prototype.updateViewport=function(a){b.extend(this.viewport,a);this.checkLayout()};c.prototype.updateOptions=function(a){b.extend(this.options,a);this.options.scrollable&&!this.scrollable&&this.makeScrollable();!this.options.scrollable&&this.scrollable&&
this.unmakeScrollable()};c.prototype.getLayoutSign=function(){var a={},c;for(c in this.blocks){var d=this.blocks[c];a[d.id]=d.layout}return b.jBlocks.util.md5(JSON.stringify({_1:a,_2:this.viewport}))};c.prototype.applyBlockLayout=function(a){var c=this.blocks[a.block.id];if("undefined"==typeof c)b.jBlocks("log","Unknown block id",a.block.id),this.anchor.find("#jblocks-block-"+this.jBlocksIndex+"-"+a.block.id).hide();else if(c.actualLayout=a,!1==c.layout.visible||this.layoutData.misfits[c.id])c.anchor.hide();
else{c.anchor.show();var d=c.anchor.position(),e=c.anchor.width(),h=c.anchor.height(),f=d.top,d=d.left,j={width:Math.round(a.w*this.geometry.uWidth),height:Math.round(a.h*this.geometry.uHeight),left:Math.round(a.c*this.geometry.uWidth),top:Math.round(a.r*this.geometry.uHeight)};e!=j.width||h!=j.height?(a=c.getContentGeometry(j,this.geometry.uWidth,this.geometry.uHeight),c.onStartResize(a,j),a.top=j.top,a.left=j.left,c.anchor.stop().animate(a,c.options.resizeAnimateDelay,function(){c.content.show();
c.onResize(j)})):(d!=j.left||f!=j.top)&&c.anchor.stop().animate({left:Math.round(a.c*this.geometry.uWidth),top:Math.round(a.r*this.geometry.uHeight)},c.options.resizeAnimateDelay,function(){})}};c.prototype.applyLayout=function(){for(var a in this.layoutData.misfits)if(this.layoutData.misfits[a]){var b=this.blocks[a];b&&b.anchor.hide()}for(var c in this.layouts)this.applyBlockLayout(this.layouts[c])};c.prototype.layoutDone=function(){var a=this.jBlocksIndex+": "+(this.layoutInProgress+1)+" "+ ++this.layoutCount+
" "+this.viewport.w+"x"+this.viewport.h+" ("+this.layoutData.maxSize.w+"x"+this.layoutData.maxSize.h+") "+((new Date).getTime()-this.layoutStatsT0)+"ms";this.options.debug&&(b("head title").text(a),u(a));"height"==this.viewport.fixed||"both"==this.viewport.fixed?this.viewport.r=0:this.viewport.h+this.viewport.r>this.layoutData.maxSize.h&&this.layoutData.maxSize.h-this.viewport.h&&(this.viewport.r=Math.max(0,this.layoutData.maxSize.h-this.viewport.h));"width"==this.viewport.fixed||"both"==this.viewport.fixed?
this.viewport.c=0:this.viewport.w+this.viewport.c>this.layoutData.maxSize.w&&this.layoutData.maxSize.w-this.viewport.w&&(this.viewport.c=Math.max(0,this.layoutData.maxSize.w-this.viewport.w));if(this.focusedBlockId&&(a=this.blocks[this.focusedBlockId])){var a=a.actualLayout,c=this.viewport.r,d=this.viewport.c;a.r+a.h>this.viewport.r+this.viewport.h?this.viewport.r=Math.max(a.r+a.h-this.viewport.h,0):a.r<this.viewport.r&&(this.viewport.r=a.r);a.c+a.w>this.viewport.c+this.viewport.w?this.viewport.c=
Math.max(a.c+a.w-this.viewport.w,0):a.c<this.viewport.c&&(this.viewport.c=a.c);if(this.viewport.r!=c||this.viewport.c!=d)a={top:-this.viewport.r*this.geometry.uHeight,left:-this.viewport.c*this.geometry.uWidth},this.frameContent.stop().animate(a,this.scrollAnimateDelay)}this.frameContent.stop().animate({top:-this.viewport.r*this.geometry.uHeight,left:-this.viewport.c*this.geometry.uWidth},this.scrollAnimateDelay);this.focusedBlockId=null;this.options.onLayoutDone.call(this)};c.prototype.focusBlockId=
function(a){this.focusedBlockId=a};c.prototype.checkSanity=function(a,b){var c=[],d={},e;for(e in a){var h=a[e];d[h.block.id]=!0;b.misfits[h.block.id]&&alert("in both layouts and misfit "+h.block.id);h.block.visible&&!b.misfits[h.block.id]&&c.push(h)}for(e in c){var h=c[e],j;for(j in c){var f=c[j];e!=j&&(f.r<h.r+h.h&&f.r+f.h>h.r&&f.c<h.c+h.w&&f.c+f.w>h.c)&&alert("mismatch "+h.block.id+" "+f.block.id+" "+JSON.stringify(h)+" "+JSON.stringify(f))}}for(var g in this.blocks)c=this.blocks[g],!d[c.id]&&
!b.misfits[c.id]&&u("missing block "+c.id)};c.prototype.rebuild=function(){if(!(0==this.viewport.h||0==this.viewport.w)){this.layoutStatsT0=(new Date).getTime();if(0==this.layoutInProgress){var a=this.layoutCache[this.layoutSign];if(a){this.checkSanity(a.layouts,a.layoutData);a.lastUsed=(new Date).getTime();this.layoutData=JSON.parse(JSON.stringify(a.layoutData));this.layouts=JSON.parse(JSON.stringify(a.layouts));this.applyLayout();this.layoutDone();return}}var a=[],c;for(c in this.blocks){var d=
...
"c";h="w";j="left";f="uWidth";g="cols";k=1;break;case "left":e="c",h="w",j="left",f="uWidth",g="cols",k=-1}for(var m=Math.ceil(d/b.geometry[f]),x=b.viewport[e];Math.abs(x-b.viewport[e])<m;){var l=-1,J;for(J in b.layoutData.rmk[g]){var p=b.layoutData.rmk[g][J];if((0<k&&p>b.viewport[e]||0>k&&p<b.viewport[e])&&(0>k||p+b.viewport[h]<=b.layoutData.maxSize[h])&&(0>l||0<k&&p<l||0>k&&p>l))l=p}if(0<=l)b.viewport[e]=l,p={},p[j]=-l*b.geometry[f],b.frameContent.stop().animate(p,b.scrollAnimateDelay);else break}}
...
arguments);case "autoSyncContentSize":var e=function(){b("body").trigger("jBlocks.resize",{width:b("body").width(),height:b("body").height()})};b(window).bind("orientationchange resize",function(){e()});b(document).ready(function(){e()});break;case "log":var f=Array.prototype.slice.call(arguments,1);u.apply(n(),[(new Date).getTime()-h].concat(f));break;case "addTranslation":return f=Array.prototype.slice.call(arguments,1),t.apply(null,f);case "translate":return f=Array.prototype.slice.call(arguments,
1),l.apply(null,f);case "getFrameData":return Array.prototype.slice.call(arguments,1),r.call(null);case "addSound":f=Array.prototype.slice.call(arguments,1);D?d.apply(null,f):L.push([d,null,f]);break;case "playSound":f=Array.prototype.slice.call(arguments,1);D?j.apply(null,f):L.push([j,null,f]);break;case "click":return O||(O="click","ontouchstart"in document.documentElement&&(O="touchstart")),O;case "getBlockAnonIndex":return q++;default:if("function"!=typeof c.prototype[a])throw"jBlocks: no such method "+
...
(function(b){b.jBlocks.util={md5:function(a){function b(a,c){var d,e,f,j,g;f=a&2147483648;j=c&2147483648;d=a&1073741824;e=c&1073741824;g=(a&1073741823)+(c&1073741823);return d&e?g^2147483648^f^j:d|e?g&1073741824?g^3221225472^f^j:g^1073741824^f^j:g^f^j}function d(a,d,e,f,j,g,k){a=b(a,b(b(d&e|~d&f,j),k));return b(a<<g|a>>>32-g,d)}function j(a,d,e,f,j,g,k){a=b(a,b(b(d&f|e&~f,j),k));return b(a<<g|a>>>32-g,d)}function n(a,d,e,f,j,g,k){a=b(a,b(b(d^e^f,j),k));return b(a<<g|a>>>32-g,d)}function u(a,d,e,f,
j,g,k){a=b(a,b(b(e^(d|~f),j),k));return b(a<<g|a>>>32-g,d)}function t(a){var b="",c="",d;for(d=0;3>=d;d++)c=a>>>8*d&255,c="0"+c.toString(16),b+=c.substr(c.length-2,2);return b}var l=[],r,v,s,f,g,e,k,m,l=a.replace(/\r\n/g,"\n");a="";for(r=0;r<l.length;r++)v=l.charCodeAt(r),128>v?a+=String.fromCharCode(v):(127<v&&2048>v?a+=String.fromCharCode(v>>6|192):(a+=String.fromCharCode(v>>12|224),a+=String.fromCharCode(v>>6&63|128)),a+=String.fromCharCode(v&63|128));l=a;a=l.length;r=a+8;v=16*((r-r%64)/64+1);
s=Array(v-1);for(g=f=0;g<a;)r=(g-g%4)/4,f=8*(g%4),s[r]|=l.charCodeAt(g)<<f,g++;r=(g-g%4)/4;s[r]|=128<<8*(g%4);s[v-2]=a<<3;s[v-1]=a>>>29;l=s;g=1732584193;e=4023233417;k=2562383102;m=271733878;for(a=0;a<l.length;a+=16)r=g,v=e,s=k,f=m,g=d(g,e,k,m,l[a+0],7,3614090360),m=d(m,g,e,k,l[a+1],12,3905402710),k=d(k,m,g,e,l[a+2],17,606105819),e=d(e,k,m,g,l[a+3],22,3250441966),g=d(g,e,k,m,l[a+4],7,4118548399),m=d(m,g,e,k,l[a+5],12,1200080426),k=d(k,m,g,e,l[a+6],17,2821735955),e=d(e,k,m,g,l[a+7],22,4249261313),
...
k=n(k,m,g,e,l[a+7],16,4139469664),e=n(e,k,m,g,l[a+10],23,3200236656),g=n(g,e,k,m,l[a+13],4,681279174),m=n(m,g,e,k,l[a+0],11,3936430074),k=n(k,m,g,e,l[a+3],16,3572445317),e=n(e,k,m,g,l[a+6],23,76029189),g=n(g,e,k,m,l[a+9],4,3654602809),m=n(m,g,e,k,l[a+12],11,3873151461),k=n(k,m,g,e,l[a+15],16,530742520),e=n(e,k,m,g,l[a+2],23,3299628645),g=u(g,e,k,m,l[a+0],6,4096336452),m=u(m,g,e,k,l[a+7],10,1126891415),k=u(k,m,g,e,l[a+14],15,2878612391),e=u(e,k,m,g,l[a+5],21,4237533241),g=u(g,e,k,m,l[a+12],6,1700485571),
m=u(m,g,e,k,l[a+3],10,2399980690),k=u(k,m,g,e,l[a+10],15,4293915773),e=u(e,k,m,g,l[a+1],21,2240044497),g=u(g,e,k,m,l[a+8],6,1873313359),m=u(m,g,e,k,l[a+15],10,4264355552),k=u(k,m,g,e,l[a+6],15,2734768916),e=u(e,k,m,g,l[a+13],21,1309151649),g=u(g,e,k,m,l[a+4],6,4149444226),m=u(m,g,e,k,l[a+11],10,3174756917),k=u(k,m,g,e,l[a+2],15,718787259),e=u(e,k,m,g,l[a+9],21,3951481745),g=b(g,r),e=b(e,v),k=b(k,s),m=b(m,f);return(t(g)+t(e)+t(k)+t(m)).toLowerCase()},sha1:function(a){function b(a,c){return a<<c|a>>>
32-c}function d(a){var b="",c,d;for(c=7;0<=c;c--)d=a>>>4*c&15,b+=d.toString(16);return b}var j,n,u=Array(80),t=1732584193,l=4023233417,r=2562383102,v=271733878,s=3285377520,f,g,e,k,m;j=a.replace(/\r\n/g,"\n");var q="";for(a=0;a<j.length;a++)n=j.charCodeAt(a),128>n?q+=String.fromCharCode(n):(127<n&&2048>n?q+=String.fromCharCode(n>>6|192):(q+=String.fromCharCode(n>>12|224),q+=String.fromCharCode(n>>6&63|128)),q+=String.fromCharCode(n&63|128));a=q;f=a.length;q=[];for(j=0;j<f-3;j+=4)n=a.charCodeAt(j)<<
24|a.charCodeAt(j+1)<<16|a.charCodeAt(j+2)<<8|a.charCodeAt(j+3),q.push(n);switch(f%4){case 0:j=2147483648;break;case 1:j=a.charCodeAt(f-1)<<24|8388608;break;case 2:j=a.charCodeAt(f-2)<<24|a.charCodeAt(f-1)<<16|32768;break;case 3:j=a.charCodeAt(f-3)<<24|a.charCodeAt(f-2)<<16|a.charCodeAt(f-1)<<8|128}for(q.push(j);14!=q.length%16;)q.push(0);q.push(f>>>29);q.push(f<<3&4294967295);for(a=0;a<q.length;a+=16){for(j=0;16>j;j++)u[j]=q[a+j];for(j=16;79>=j;j++)u[j]=b(u[j-3]^u[j-8]^u[j-14]^u[j-16],1);n=t;f=l;
g=r;e=v;k=s;for(j=0;19>=j;j++)m=b(n,5)+(f&g|~f&e)+k+u[j]+1518500249&4294967295,k=e,e=g,g=b(f,30),f=n,n=m;for(j=20;39>=j;j++)m=b(n,5)+(f^g^e)+k+u[j]+1859775393&4294967295,k=e,e=g,g=b(f,30),f=n,n=m;for(j=40;59>=j;j++)m=b(n,5)+(f&g|f&e|g&e)+k+u[j]+2400959708&4294967295,k=e,e=g,g=b(f,30),f=n,n=m;for(j=60;79>=j;j++)m=b(n,5)+(f^g^e)+k+u[j]+3395469782&4294967295,k=e,e=g,g=b(f,30),f=n,n=m;t=t+n&4294967295;l=l+f&4294967295;r=r+g&4294967295;v=v+e&4294967295;s=s+k&4294967295}m=d(t)+d(l)+d(r)+d(v)+d(s);return m.toLowerCase()}}})(jQuery);
...
{"0":0};c.rmk.cols[a.w]=a.w;c.misfits={};for(var n=[],u=[],t={w:-1,h:-1};0<b.length;){var l=b.shift();if(l.visible){for(var r=j(l),v=[],s=0;s<r.length;s++){var f=r[s];if(l.w<=f.w&&l.h<=f.h){for(var g=!0,e=0;e<n.length&&g;e++)if(h=n[e],!(h.r+h.block.h<=f.r||h.r>=f.r+f.h||h.c+h.block.w<=f.c||h.c>=f.c+f.w)){g=!1;break}g&&v.push(f)}}h=l.pref;if(!l.pref||"default"==l.pref)h="height"==a.fixed?"left top":"top left";var f=null,k=function(b,c){return b.r<a.h&&c.r>=a.h?-1:c.r<a.h&&b.r>=a.h?1:Math.abs(b.r+b.h-
a.h)-Math.abs(c.r+c.h-a.h)},m=function(b,c){return Math.abs(b.c+b.w-a.w)-Math.abs(c.c+c.w-a.w)},q=function(a,b){return a.w*a.h-b.w*b.h};switch(h){case "top right":f=function(a,b){return a.r-b.r||m(a,b)||q(a,b)};break;case "right top":f=function(a,b){return m(a,b)||a.r-b.r||q(a,b)};break;case "bottom left":f=function(a,b){return k(a,b)||a.c-b.c||q(a,b)};break;case "left bottom":f=function(a,b){return a.c-b.c||k(a,b)||q(a,b)};break;case "bottom right":f=function(a,b){return k(a,b)||m(a,b)||q(a,b)};
break;case "right bottom":f=function(a,b){return m(a,b)||k(a,b)||q(a,b)};break;case "left top":f=function(a,b){return a.c-b.c||a.r-b.r||q(a,b)};break;case "top left":f=function(a,b){return a.r-b.r||a.c-b.c||q(a,b)};break;case "center":f=function(b,c){var d=Math.min(b.c+b.w,a.w)-b.c,e=Math.min(b.r+b.h,a.h)-b.r,f=Math.min(c.c+c.w,a.w)-c.c,g=Math.min(c.r+c.h,a.h)-c.r;return f*g-d*e};break;default:$jBlocks("log","Unknown block.pref",l.pref)}v.sort(f);if(0==v.length){f=0;for(r=n.length-1;0<=r;r--)h=n[r],
h.block.importance<l.importance&&($.jBlocks.worker.supported&&self.postMessage({cmd:"layout",args:{layout:{block:h.block},misfit:!0},jBlocksIndex:d}),c.misfits[h.block.id]=!0,b.unshift(h.block),n.splice(r,1),f++);0==f?(c.misfits[l.id]=!0,$.jBlocks.worker.supported&&self.postMessage({cmd:"layout",args:{layout:{block:l},misfit:!0},jBlocksIndex:d})):b.unshift(l)}else{r="left";s="top";l.pref&&(0<=l.pref.indexOf("right")&&(r="right"),0<=l.pref.indexOf("bottom")&&(s="bottom"),0<=l.pref.indexOf("center")&&
(r=s="center"));f=v[0];h={r:"top"==s?f.r:f.r+f.h-l.h,c:"left"==r?f.c:f.c+f.w-l.w,h:l.h,w:l.w,block:l};switch(s){case "top":h.r=f.r;break;case "bottom":h.r=f.r+f.h-l.h;break;case "center":h.r=f.r+Math.floor((f.h-l.h)/2)}switch(r){case "left":h.c=f.c;break;case "right":h.c=f.c+f.w-l.w;break;case "center":h.c=f.c+Math.floor((f.w-l.w)/2)}c.rmk.rows[h.r]=h.r;c.rmk.rows[h.r+h.block.h]=h.r+h.block.h;c.rmk.cols[h.c]=h.c;c.rmk.cols[h.c+h.block.w]=h.c+h.block.w;delete c.misfits[h.block.id];$.jBlocks.worker.supported&&
self.postMessage({cmd:"layout",args:{layout:h,misfit:!1},jBlocksIndex:d});n.push(h);if(0>t.w||h.c+h.block.w>t.w)t.w=h.c+h.block.w;if(0>t.h||h.r+h.block.h>t.h)t.h=h.r+h.block.h}}else{var h={block:l,visible:!1};u.push(h);$.jBlocks.worker.supported&&self.postMessage({cmd:"layout",args:{layout:h,misfit:!1},jBlocksIndex:d})}}a.frameSize=t;c.maxSize={w:0,h:0};for(e=0;e<n.length;e++)h=n[e],c.maxSize.h<h.r+h.h&&(c.maxSize.h=h.r+h.h),c.maxSize.w<h.c+h.w&&(c.maxSize.w=h.c+h.w);c.rmk.rows={"0":0};c.rmk.rows[a.h]=
a.h;c.rmk.cols={"0":0};c.rmk.cols[a.w]=a.w;for(e=0;e<n.length;e++)h=n[e],c.rmk.rows[h.r]=h.r,c.rmk.rows[h.r+h.h]=h.r+h.h,c.rmk.cols[h.c]=h.c,c.rmk.cols[h.c+h.w]=h.c+h.w;c.maxSize.h>a.h&&(c.rmk.rows[c.maxSize.h-a.h]=c.maxSize.h-a.h);c.maxSize.w>a.w&&(c.rmk.cols[c.maxSize.w-a.w]=c.maxSize.w-a.w);if(a.fillHoles){r=j(null);r.sort(function(a,b){return b.w*b.h-a.w*a.h});for(b=!0;b;){b=!1;for(s=0;s<r.length&&!b;s++){f=r[s];t=!0;for(e=0;e<n.length&&t;e++)if(h=n[e],!(h.r+h.h<=f.r||h.r>=f.r+f.h||h.c+h.w<=f.c||
h.c>=f.c+f.w)){t=!1;break}if(t&&(f.c+f.w<=c.maxSize.w||f.c+f.w<=a.w)&&(f.r+f.h<=c.maxSize.h||f.r+f.h<=a.h)){t=[];for(e=0;e<n.length;e++)h=n[e],c.misfits[h.block.id]||(0<h.block.expandWidth&&(h.r>=f.r&&h.r+h.h<=f.r+f.h)&&(h.c+h.w==f.c&&t.push({li:e,change:{w:h.w+f.w},weight:"expandWidth"}),f.c+f.w==h.c&&t.push({li:e,change:{c:h.c-f.w,w:h.w+f.w},weight:"expandWidth"})),0<h.block.expandHeight&&(h.c>=f.c&&h.c+h.w<=f.c+f.w)&&(h.r+h.h==f.r&&t.push({li:e,change:{h:h.h+f.h},weight:"expandHeight"}),f.r+f.h==
h.r&&t.push({li:e,change:{r:h.r-f.h,h:h.h+f.h},weight:"expandHeight"})));0<t.length&&(b=!0,t.sort(function(a,b){return n[b.li].block[b.weight]-n[a.li].block[a.weight]}),t=t[0],h=n[t.li],$.jBlocks.worker.extend(h,t.change),$.jBlocks.worker.supported&&self.postMessage({cmd:"layout",args:{layout:h,misfit:!1},jBlocksIndex:d}))}}}}return n.concat(u)}};
...
$.jBlocks("defineBlockClass","Block","Class",{init:function(b,a){2>arguments.length&&(a={});1>arguments.length&&(b={});this.id=a.id?a.id:"anon-"+$.jBlocks("getBlockAnonIndex");this.layout={priority:0,importance:0,w:1,h:1,pref:"default",visible:!0,expandWidth:1,expandHeight:1};this.actualLayout={w:1,h:1};$.extend(this.layout,b);this.maximized=!1;this.jBlocks=null;this.className="Block";this.options={blockClass:null,blockContentClass:null,margin:null,padding:null,borderRadius:0.15,contentBorderRadius:0,
capture:!1,maximizable:!0,requireAuth:!1,requireAnon:!1,autoFit:!1,resizeAnimateDelay:400,debugBlockLayout:!1,onCreate:function(){},onRemove:function(){},onResize:function(){},onStartResize:function(){},tooltip:null,earlyLayout:!0};this.tags={};$.extend(this.options,a);this.options.requireAuth&&null==$.jBlocks.loggedIn&&(this.layout.visible=!1);this.options.requireAnon&&null!=$.jBlocks.loggedIn&&(this.layout.visible=!1)},create:function(b){this.options.layouts&&("undefined"==typeof this.options.layoutIndex&&
(this.options.layoutIndex=Math.floor((this.options.layouts.length-1)/2)),this.options.w=function(b){var c=a.options.layouts[a.options.layoutIndex];switch(typeof c.w){case "number":return c.w;case "function":return c.w.call(a,b);default:return a.layout.w}},this.options.h=function(b){var c=a.options.layouts[a.options.layoutIndex];switch(typeof c.h){case "number":return c.h;case "function":return c.h.call(a,b);default:return a.layout.h}});var a=this,c=this.options.blockClass||this.jBlocks.options.blockClass;
this.anchor=$("<div/>").appendTo(b.children(".jblocks-frame").children(".jblocks-frame-content"));this.anchor.addClass("jblocks-block").addClass("jblocks-"+this.jBlocks.jBlocksIndex).attr("id","jblocks-block-"+this.jBlocks.jBlocksIndex+"-"+this.id).css({top:$("body").height()/2,left:$("body").width()/2,width:1,height:1});c&&this.anchor.addClass(c);(this.options.debugBlockLayout||this.jBlocks.options.debugBlockLayout)&&this.anchor.bind("mouseover",function(b){$("head title").text(a.className+" "+JSON.stringify(a.layout));
b.stopPropagation()});this.captMask=$("<div/>").addClass("jblocks-block-mask").appendTo(this.anchor);b=this.options.blockContentClass||this.jBlocks.options.blockContentClass;this.content=$("<div/>").addClass("jblocks-block-content").appendTo(this.anchor);b&&this.content.addClass(b);this.options.tooltip&&this.content.attr("title",this.options.tooltip);this.onCreate();this.options.onCreate.call(this)},onRemove:function(){this.anchor&&this.anchor.remove();this.options.onRemove()},remove:function(){this.jBlocks.removeBlock(this.id)},
canGrow:function(){return this.options.layouts&&this.options.layoutIndex<this.options.layouts.length-1},grow:function(){this.canGrow()&&(this.options.layoutIndex++,this.jBlocks.checkLayout(),this.focus())},canShrink:function(){return this.options.layouts&&0<this.options.layoutIndex},shrink:function(){this.canShrink()&&(this.options.layoutIndex--,this.jBlocks.checkLayout(),this.focus())},focus:function(){this.jBlocks.focusBlockId(this.id)},addTag:function(b){this.tags[b]=!0},maximize:function(){!this.maximized&&
this.options.maximizable&&($.extend(options,options0),this.jBlocks.pushLayout(),this.jBlocks.hideAllBlocks(),this.layout.visible=!0,this.layout.w=this.jBlocks.viewport.w,this.layout.h=this.jBlocks.viewport.h,this.jBlocks.checkLayout(),this.maximized=!0)},unMaximize:function(){this.maximized&&(this.jBlocks.popLayout(),this.maximized=!1,this.jBlocks.checkLayout())},onCreate:function(){},onStartResize:function(b){this.options.onStartResize.call(this,b)},getContentGeometry:function(b,a,c){a=Math.min(a,
c);c=this.jBlocks.options.margin;this.options.margin&&(c=this.options.margin);var d=this.jBlocks.options.padding;this.options.padding&&(d=this.options.padding);var j={"margin-top":a*c[0],"margin-bottom":a*c[2],"margin-left":a*c[3],"margin-right":a*c[1],"padding-top":a*d[0],"padding-bottom":a*d[2],"padding-left":a*d[3],"padding-right":a*d[1],"border-left":parseInt(this.anchor.css("border-left-width")),"border-right":parseInt(this.anchor.css("border-right-width")),"border-top":parseInt(this.anchor.css("border-top-width")),
"border-bottom":parseInt(this.anchor.css("border-bottom-width"))};return{spacing:j,sizeRef:a,width:b.width-(c[1]+c[3])*a-(d[1]+d[3])*a-j["border-left"]-j["border-right"],height:b.height-(c[0]+c[2])*a-(d[0]+d[2])*a-j["border-right"]-j["border-bottom"]}},onResize:function(b){b=this.getContentGeometry(b,this.jBlocks.geometry.uWidth,this.jBlocks.geometry.uHeight);this.content.width(b.width);this.content.height(b.height);this.content.css("border-radius",b.sizeRef*this.options.contentBorderRadius+"px");
this.anchor.css({"margin-top":b.spacing["margin-top"]+"px","margin-bottom":b.spacing["margin-bottom"]+"px","margin-left":b.spacing["margin-left"]+"px","margin-right":b.spacing["margin-right"]+"px","padding-top":b.spacing["padding-top"]+"px","padding-bottom":b.spacing["padding-bottom"]+"px","padding-left":b.spacing["padding-left"]+"px","padding-right":b.spacing["padding-right"]+"px"});this.anchor.width(b.width);this.anchor.height(b.height);this.anchor.css("border-radius",b.sizeRef*this.options.borderRadius+
"px");this.captMask.width(this.anchor.outerWidth(!1)-b.spacing["border-left"]-b.spacing["border-right"]);this.captMask.height(this.anchor.outerHeight(!1)-b.spacing["border-top"]-b.spacing["border-bottom"]);this.options.capture?this.captMask.show():this.captMask.hide();this.options.onResize.call(this,b);var a=this.jBlocks.options.blockShadow;"undefined"!=typeof this.options.shadow&&(a=this.options.shadow);if(0!=a){var c=this.jBlocks.geometry.uWidth*a,d=this.jBlocks.geometry.uHeight*a,a=b.sizeRef*a;
this.anchor.css({"-webkit-box-shadow":"-"+c+"px "+d+"px "+2.5*a+"px rgba(43, 45, 50, 0.55)","box-shadow":"-"+c+"px "+d+"px "+2.5*a+"px rgba(43, 45, 50, 0.55)"})}this.display(b)},display:function(){},onLoggedIn:function(b){this.options.requireAuth&&!1==this.layout.visible&&(this.layout.visible=!0,this.jBlocks.checkLayout());this.options.requireAnon&&!0==this.layout.visible&&(this.layout.visible=!1,this.jBlocks.checkLayout());if(this.onLoggedInCallback)this.onLoggedInCallback(b)},onLoggedOut:function(){this.options.requireAuth&&
!0==this.layout.visible&&(this.layout.visible=!1,this.jBlocks.checkLayout());this.options.requireAnon&&!1==this.layout.visible&&(this.layout.visible=!0,this.jBlocks.checkLayout());if(this.onLoggedOutCallback)this.onLoggedOutCallback()},canFullscreen:function(){return null!=this.jBlocks.fullscreenMethods},fullscreen:function(b,a){if(1>arguments.length||!b)b=this.content;if(2>arguments.length||!a)udateFnt=function(){};this.jBlocks.fullscreen(b,a)},log:function(){$.jBlocks.apply(null,["log"].concat([].splice.call(arguments,
0)))},t:function(){return $.jBlocks.apply(null,["translate"].concat([].splice.call(arguments,0)))}});
...
u=b*this.options.epadding[1],t=b*this.options.epadding[2],b=b*this.options.epadding[3],l=parseInt(this.element.css("border-top-width"))+parseInt(this.element.css("border-bottom-width")),r=parseInt(this.element.css("border-left-width"))+parseInt(this.element.css("border-right-width"));this.element.css({"margin-top":a+"px","margin-right":c+"px","margin-bottom":d+"px","margin-left":j+"px","padding-top":n+"px","padding-right":u+"px","padding-bottom":t+"px","padding-left":b+"px",height:this.content.height()-
n-a-t-d-l,width:this.content.width()-b-j-u-c-r})}});
...
shouldDisplay:function(){return!0}};$.extend(c,this.options.menuItems[a]);var d=this.selfJBlocks.addNewBlock("Link",{w:1,h:1,pref:"left top",expandHeight:0,expandWidth:0},{text:c.label,containerTag:"a"});this.menuItems.push({data:c,block:d});(function(a){d.anchor.bind("click",function(){a.onClick.call(b)})})(c)}this.selfJBlocks.updateOptions({onResize:function(a,c){c.w=b.options.w}})},display:function(){this._super();var b=0,a;for(a in this.menuItems){var c=this.menuItems[a];c.data.shouldDisplay()?
...
$.jBlocks("defineBlockClass","Box","JBlock",{init:function(){this._super.apply(this,arguments);this.options=$.extend({title:"",focusOnTitleClick:!0,haveClose:!1,haveSearch:!1,haveMaximize:!0,haveFullscreen:!1,closeIconClass:"jblocks-icon-close",shrinkIconClass:"jblocks-icon-shrink",growIconClass:"jblocks-icon-grow",searchIconClass:"jblocks-icon-search",iconsBaseClass:"jblocks-block-icon",menuItems:[],onSearchClick:function(){}},this.options)},onCreate:function(){var b=this;this._super();var a=this.selfJBlocks.options.onResize;
this.selfJBlocks.options.onResize=function(){a.apply(this,arguments);b.options.layouts&&(b.growIcon.layout.visible=b.canGrow()?!0:!1,b.shrinkIcon.layout.visible=b.canShrink()?!0:!1)};var c=[];this.options.haveFullscreen&&c.push({label:this.t("fullscreen"),onClick:function(){this.layout.visible=!1;b.fullscreen(b.selfJBlocks.anchor,function(a){a?b.maximize():b.unMaximize();$(window).trigger("resize")})},shouldDisplay:function(){return b.canFullscreen()}});for(var d in this.options.menuItems)c.push(this.options.menuItems[d]);
0<c.length&&this.selfJBlocks.addNewBlock("MenuIcon",{priority:1003,pref:"top left",h:1,w:1,expandHeight:0},{onClick:function(){alert("Open menu")},menuItems:c});this.options.haveClose&&this.selfJBlocks.addNewBlock("Icon",{priority:1002,pref:"top left"},{iconClass:this.options.iconsBaseClass,blockContentClass:this.options.closeIconClass,onClick:function(){b.unMaximize();b.jBlocks.removeBlock(b.id)},tooltip:this.t("close")});this.options.haveSearch&&this.selfJBlocks.addNewBlock("Icon",{priority:1001,
pref:"top right"},{iconClass:this.options.iconsBaseClass,blockContentClass:this.options.searchIconClass,onClick:function(){b.options.onSearchClick.apply(b)},tooltip:this.t("search")});this.options.layouts&&(this.growIcon=this.selfJBlocks.addNewBlock("Icon",{priority:1001,pref:"top right"},{iconClass:this.options.iconsBaseClass,blockContentClass:this.options.growIconClass,onClick:function(){b.grow()},tooltip:this.t("grow")}),this.shrinkIcon=this.selfJBlocks.addNewBlock("Icon",{priority:1001,pref:"top right"},
{iconClass:this.options.iconsBaseClass,blockContentClass:this.options.shrinkIconClass,onClick:function(){b.shrink()},tooltip:this.t("shrink")}));c=this.selfJBlocks.addNewBlock("Text",{h:1,w:2,priority:1E3,expandWidth:10,expandHeight:0},{containerTag:"h1",text:this.options.title});this.options.focusOnTitleClick&&c.content.bind("click",function(){b.focus();b.jBlocks.checkLayout()})},setContent:function(b,a){2>arguments.length&&(a={});for(var c in this.selfJBlocks.blocks){var d=this.selfJBlocks.blocks[c];
d._isBoxContent&&this.selfJBlocks.removeBlock(d.id)}c=this.selfJBlocks.addNewBlock(b,{w:1,h:2,pref:"right bottom",priority:999,expandWidth:2,expandHeight:2},$.extend(a,{boxBlock:this}));c._isBoxContent=!0;return c}});
$.jBlocks("defineBlockClass","ScrollableHtml","Block",{init:function(){this._super.apply(this,arguments);this.options=$.extend({htmlContent:"",scrollAnimation:0,verticalAlign:!1},this.options)},onCreate:function(){var b=this,a=this.content;this.scrollCtrl=$("<div/>").addClass("jb-scroll-list").appendTo(this.content);var c=$("<div/>").addClass("scrollbar").appendTo(this.scrollCtrl),d=$("<div/>").addClass("track").appendTo(c);$("<div/>").addClass("tracktop").appendTo(d);var j=$("<div/>").addClass("thumb").appendTo(d);
$("<div/>").addClass("top").appendTo(j);$("<div/>").addClass("bottom").appendTo(j);a=$("<div/>").addClass("viewport").appendTo(this.scrollCtrl);a=this.scrollViewport=$("<div/>").addClass("overview").appendTo(a);this.content.bind("mousewheel DOMMouseScroll",function(a){if(!c.hasClass("disable")){var b=0>a.detail||0<a.wheelDelta?1:-1,t=j.position();0<b&&0==t.top||0>b&&t.top+j.height()>=d.height()||a.stopPropagation()}});a.html(this.options.htmlContent);this.scrollCtrl.tinyscrollbar({animation:this.options.scrollAnimation}).bind("updatelayout",
...
$.jBlocks("defineBlockClass","Select","List",{init:function(){var b=this;this._super.apply(this,arguments);this.options=$.extend({opened:!1,selected:null,selWidgetClass:"jblocks-block-grey",onChange:function(){}},this.options);this.superCreateItem=this.options.createItem;this.options.createItem=function(a,c){var d=b.superCreateItem.call(this,a,c);c.bind("click",function(){b.val(d);b.list.layout.visible=!1;b.selWidget.layout.visible=!0;b.selfJBlocks.checkLayout();b.options.opened=!1;b.jBlocks.checkLayout()});
